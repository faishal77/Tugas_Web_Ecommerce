...
const Register = () => {
  ...
  return (
   <>
  {/* !! Components */}
<div className="bg-white flex justify-center items-center h-[100dvh]">
    {/* <!-- Left: Image --> */}
<div className="w-1/2 h-max  hidden lg:block">
...
<img className="h-14 w-14" src="https://i.pinimg.com/736x/c1/88/8a/c1888a724d78d6fc944e28a604659c52.jpg" alt="" srcset="" />
  <a className="btn btn-ghost normal-case text-xl text-blue-900">FR_Ecommerce</a>
    ...
    <div className="w-[100%] ml-3 m-auto mt-[-1vmax] bg-slate-500 h-[78dvh]">
    <img className="object-cover w-full h-full" src="https://i.pinimg.com/564x/b4/d7/c7/b4d7c745521e0469de2fe08e902e0965.jpg" alt="" srcset="" />
    <h1 className="text-center mt-[-2.3vmax] text-[1.3rem] font-sans font-semibold">Start for free and get<br/>attractive offers.</h1>
    </div>
  </div>
{/* <!-- Right: Login Form --> */}
<div className="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2">
  <h1 className="text-3xl font-bold mb-4">Get's started.</h1>
  <p className="text-[.8rem] mt-[-10px] text-slate-400">Already have an account? <Link href={'../Login'} className="text-orange-400">Log In</Link></p>
...
style="fill:#FFFFFF;">
  ...
  <form action="#" method="POST" className="mt-5">
    ...
    <div className="mb-4 flex items-center">
      ...
      <label  className="text-gray-600 ml-2 text-[.8rem]">I agree in platform's <b className="text-orange-600">Terms of Service</b> and <b className="text-orange-600">Privacy Policy</b> </label>
    </div>

    <button type="submit" className="bg-orange-400 hover:bg-orange-600 text-white font-semibold rounded-md py-2 px-4 w-full">Register</button>
  </form>
</div>
</div>
   </>
